...
CREATE TABLE interference_tests (
    ...
    environment_type ENUM('lapangan', 'hangar', 'pantai', 'gunung', 'indoor', 'outdoor'),
    measurement_code VARCHAR(50),
    scan_status ENUM('not_scanned', 'clear', 'detected', 'inconclusive'),
    scan_start_mhz DECIMAL(7,2) DEFAULT 860.00,
    scan_end_mhz DECIMAL(7,2) DEFAULT 930.00,
    noise_floor_dbm DECIMAL(6,2),
    strongest_interferer_frequency_mhz DECIMAL(7,2),
    strongest_interferer_power_dbm DECIMAL(6,2),
    channel_occupancy_percent DECIMAL(5,2),
    sdr_device VARCHAR(100),
    interference_evidence TEXT,
