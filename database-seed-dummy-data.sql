...
('2026-04-23', 'scan', 'ESP32 local', 'SLAVE-HALOW-01',
    1000000, 1000230, 1001450, 'success', 230, 1220,
    1450, 100, 'Scan Networks example completed successfully'),
('2026-04-23', 'rf-test', 'morsectrl UART', 'MM6108',
    2000000, 2000560, 2002340, 'success', 560, 1780,
    2340, 100, 'RF test ATE command executed through UART SLIP'),
('2026-04-23', 'porting assistant', 'ESP32 local', 'MM6108',
    3000000, 3001200, 3001890, 'success', 1200, 690,
    1890, 100, 'Porting assistant self-test sequence executed'),
('2026-04-23', 'iperf', 'ESP32 local', 'SLAVE-HALOW-01',
    4000000, 4002500, 4004200, 'success', 2500, 1700,
    4200, 100, 'Iperf UDP server started and accepted traffic'),
('2026-04-23', 'web camera server', 'Website', 'SLAVE-HALOW-01',
    5000000, 5000890, 5001560, 'success', 890, 670,
    1560, 100, 'Web camera server request delivered');
